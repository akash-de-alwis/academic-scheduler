...
<h1 className="text-4xl font-bold text-gray-800 mb-4">Room & Facility Booking</h1>
<p className="text-gray-600 text-lg mb-6">
          Easily book and manage classrooms, labs, and facilities without scheduling conflicts.
</p>
