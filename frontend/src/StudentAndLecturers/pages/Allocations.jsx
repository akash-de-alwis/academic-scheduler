...
export default function Allocations() {
    ...
    // Keep all the existing useEffect hooks and handler functions the same
    useEffect(() => {
    ...
    const handleSave = async () => {
        try {
            if (editingAllocation) {
                const res = await axios.put(`http://localhost:5000/api/allocations/${editingAllocation._id}`, newAllocation);
    ...
    return (
        <div className="min-h-screen p-8 bg-[#FFFFFF]">
            ...
            {allocations.map((allocation) => (
                <div key={allocation._id} className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                ...
                <div className="p-5">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wider">Subject</p>
                        <p className="text-[#1B365D] font-semibold">{allocation.subjectName}</p>
                        <p className="text-xs text-gray-400 mt-0.5">{allocation.subjectId}</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-lg w-[480px]">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <select
                                    value={newAllocation.subjectName}
                                    onChange={(e) => {
                                        const selected = subjects.find(s => s.subjectName === e.target.value);
